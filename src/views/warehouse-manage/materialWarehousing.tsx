...
import MaterialWarehousingApi, {
  IMaterialWarehousingQuery,
  IMaterialWarehousingRes
} from "@/api/tsx/warehouse-manage/materialWarehousingApi"
...
/** 物料出库管理 */
export default new (class MaterialWarehousing extends PageBase {
  private api = new MaterialWarehousingApi()
  private query: IMaterialWarehousingQuery = {}
